...
export default function SeekerSignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(false)
    console.log("Seeker sign up:", formData)
  }
          ...
          <Card className="shadow-xl border bg-card/80 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center text-sm">
                ...
                <Link href="/auth/seeker/signin" className="text-primary hover:text-primary/80 font-medium">
                  Sign in here
                </Link>
              </div>

              <div className="text-center">
                <Link href="/auth/recruiter/signup" className="text-sm text-foreground/60 hover:text-primary">
                  Are you a recruiter? Create recruiter account
                </Link>
              </div>
            </CardContent>
          </Card>
