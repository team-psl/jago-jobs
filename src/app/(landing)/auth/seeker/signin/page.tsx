...
export default function SeekerSignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(false)
    console.log("Seeker sign in:", { email, password })
  }
        ...
        <div className="max-w-md mx-auto">
          ...
          <Card className="shadow-xl max-sm:border-none max-sm:bg-transparent max-sm:shadow-none bg-card/80 backdrop-blur-sm">
            <CardHeader className="text-center space-y-2 mb-2">
              ...
              <div className="">
                <CardTitle className="text-2xl font-bold text-card-foreground">Welcome Back, Job Seeker!</CardTitle>
            ...
            <CardContent className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/auth/seeker/forgot-password" className="text-sm text-primary hover:text-primary/80">
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="text-center text-sm">
                ...
                <Link href="/auth/seeker/signup" className="text-primary hover:text-primary/80 font-medium">
                  Sign up here
                </Link>
              </div>

              <div className="text-center">
                <Link href="/auth/recruiter/signin" className="text-sm text-foreground/60 hover:text-primary">
